...
const DataSidebar = ({ data, sessionId, onSelectField }) => {
                        ...
                        .map(([key, item]) => {
                            ...
                            const hasValidCoords = (() => {
                                ...
                                if (item.source_location) {
                                    ...
                                    // Valid if any dimension is non-zero and page > 0
                                    if (loc.page > 0 && (loc.x !== 0 || loc.y !== 0 || loc.w !== 0 || loc.h !== 0)) return true;
                                }
                            ...
                            return (
                                <div
                                    ...
                                    onClick={() => {
                                        if (hasValidCoords) {
                                            ...
                                            if (item.source_location && item.source_location.page > 0) {
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-2 mb-2">
                                        {hasValidCoords ? (
                                            <button className="text-[10px] uppercase tracking-wider font-bold text-blue-700 bg-blue-100 px-2 py-0.5 rounded border border-blue-200 flex items-center gap-1 hover:bg-blue-200 cursor-pointer">
                                                🔍 View in PDF
                                            </button>
                                        ) : (
                                            <span className="text-[10px] uppercase tracking-wider font-bold text-amber-700 bg-amber-100 px-2 py-0.5 rounded border border-amber-200 flex items-center gap-1">
